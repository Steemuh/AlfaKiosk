	...
	return (
		<div className="space-y-4 sm:space-y-6">
			...
			<div className="grid grid-cols-2 gap-2 sm:gap-4 lg:grid-cols-4">
				...
				<StatCard label="Total Incoming" value={incomingOrders.length.toString()} color="blue" theme={theme} />
				<StatCard label="Avg Wait" value="5 min" color="yellow" theme={theme} />
				<StatCard label="Acceptance Rate" value="98%" color="green" theme={theme} />
			</div>
